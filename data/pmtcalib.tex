...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{PMTRelated/Dynode-PMT_fit.pdf}
		\caption{}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{PMTRelated/MCP-PMT_fit.pdf}
		\caption{}
		\label{fig:mcp-fit}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{PMTRelated/gm.pdf}
		\caption{}
		\label{fig:gm}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{PMTRelated/mcp-gpm.pdf}
		\caption{}
		\label{fig:gmp_mcp}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{PMTRelated/offset.pdf}
		\caption{}
		\label{fig:offset}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{PMTRelated/TTS.pdf}
		\caption{}
		\label{fig:tts}
	\end{subfigure}
...
The Photon Detection Efficiency~(PDE) is an important parameter for measuring the photon detection ability of a PMT. Numerically, it is equal to the product of QE and CE. In this work, we directly use the results obtained from the batch tests at Pan-Asia~\cite{JUNO:2022hlz}, as shown in Fig.~\ref{fig:PDE}.
\begin{figure}[!htbp]
	\centering
