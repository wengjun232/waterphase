...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/furman.pdf}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/fit_noald.pdf}
		\caption{}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/fit_ald.pdf}
		\caption{}
		\label{fig:gain_ald}
	\end{subfigure}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/gain_mu.pdf}
		\caption{}
		\label{fig:gain}
	\end{subfigure}%
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/gain_sigma.pdf}
		\caption{}
		\label{fig:sigma}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/gain_sigmamu.pdf}
		\caption{}
		\label{fig:sigmamu}
	\end{subfigure}
...
\begin{figure}[!htbp]
	\begin{subfigure}{0.5\linewidth}
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/true_all.pdf}
		\caption{}
		\label{fig:true_n}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\linewidth}
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/allmode.pdf}
		\caption{}
		\label{fig:allmode}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/p.pdf}
		\caption{}
		\label{fig:p}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/ts.pdf}
		\caption{}
		\label{fig:ts}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/cour.pdf}
		\caption{}
		\label{fig:cour}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/hist.pdf}
		\caption{}
		\label{fig:hist}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/parameter_pp0.pdf}
		\caption{}
		\label{fig:pp0}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/parameters_ts.pdf}
		\caption{}
		\label{fig:tsts}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/GTmodel/single_pecharge.pdf}
		\caption{}
		\label{fig:single_pe}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.97\linewidth]{PMTRelated/GTmodel/singlepefit.pdf}
		\caption{}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{PMTRelated/Gain_DCR_window.pdf}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/Dynode-PMT_fit.pdf}
		\caption{}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/MCP-PMT_fit.pdf}
		\caption{}
		\label{fig:mcp-fit}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{PMTRelated/gp.pdf}
		\caption{}
		\label{fig:gp}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/gm.pdf}
		\caption{}
		\label{fig:gm}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/mcp-gpm.pdf}
		\caption{}
		\label{fig:gmp_mcp}
	\end{subfigure}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.6\textwidth}
		\centering
		\includegraphics[width=\linewidth]{PMTRelated/dcr_3279.pdf}
		\caption{}
		\label{fig:dcr}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{PMTRelated/dcr_3279_pos.pdf}
		\caption{}
		\label{fig:dcrpos}
	\end{subfigure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{PMTRelated/dcr_time.pdf}
...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/offset.pdf}
		\caption{}
		\label{fig:offset}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{PMTRelated/TTS.pdf}
		\caption{}
		\label{fig:tts}
	\end{subfigure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{PMTRelated/PDE.pdf}
