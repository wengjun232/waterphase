...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption{\subref{fig:solar_gamma_angle}: The definition of Gamma angle. \subref{fig:solar_gamma_dis}: The distribution of $\cos\theta_{\gamma}$ in calibration Run~3286.}
