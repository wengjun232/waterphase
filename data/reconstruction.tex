...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{reconstruction/I0.pdf}
		\caption{$I_0$}
		\label{fig:I0}
	\end{subfigure}% 
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{reconstruction/I1.pdf}
		\caption{$I_1$}
		\label{fig:I1}
	\end{subfigure}%
	\hfill
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.95\linewidth]{reconstruction/I2.pdf}
		\caption{$I_2$}
		\label{fig:I2}
	\end{subfigure}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=1,width=0.95\linewidth]{reconstruction/scatter_ratio.pdf}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=2,width=0.95\linewidth]{reconstruction/scatter_ratio.pdf}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=5,width=0.95\linewidth]{reconstruction/scatter_ratio.pdf}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=1, width=0.9\linewidth]{reconstruction/timepdf/sub_0.pdf}
		\caption{Without TTS smearing}
		\label{fig:smear0}
	\end{subfigure}% 
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=1, width=0.9\linewidth]{reconstruction/timepdf/sub_5.pdf}
...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.5\textwidth} % 宽度调整为0.32（留出间隙）
		\centering
		\includegraphics[page=3, width=0.95\linewidth]{reconstruction/parameters_Define/glass.pdf}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=6, width=0.95\linewidth]{reconstruction/parameters_Define/glass.pdf}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[page=9, width=0.95\linewidth]{reconstruction/parameters_Define/glass.pdf}
