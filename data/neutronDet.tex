...
\begin{table}[htbp]
	\caption{\textbf{Neutron Tagging Optimization Parameter Scan Specifications}}%标题
...
\section{The spallation neutron yield calibration}
...
\begin{table}[H]
	\caption{\textbf{The efficiencies in spallation neutron search}}%标题bottomrule
	\label{tab:spn_eff}
	\centering%把表居中
	\begin{tabular}{ccc}
		\toprule%第一道横线
...
\begin{table}[H]
	\caption{\textbf{The systematic uncertainty in spallation neutron search}}%标题
...
\begin{figure}[htbp]
	\centering
	\includegraphics[page=22, width=0.4\linewidth]{spallation_n/yield_sjtu.pdf}
